...
const jsonLd = {
  ...
  name: 'おたよりん',
  url: 'https://otayorin.vercel.app',
  description: '学校・保育園のお便りを写真に撮るだけ。Googleカレンダーに自動登録。持ち物リストも自動抽出。手入力ゼロ。',
      ...
      <footer className="border-t border-gray-100 py-8">
        <div className="max-w-xl mx-auto px-4 text-center">
          ...
          <div className="flex justify-center gap-4 mt-3 flex-wrap">
            ...
            <Link href="/archive" className="text-gray-300 text-xs hover:text-gray-500">アーカイブ</Link>
            <Link href="/privacy" className="text-gray-300 text-xs hover:text-gray-500">プライバシーポリシー</Link>
          </div>
          <p className="text-gray-200 text-xs mt-4">© 2025 おたよりん</p>
        </div>
      </footer>
    </div>
  )
